    ...
    <div className="bg-white border rounded-4 mt-3">
      ...
      <div className="p-4">
          ...
          <table className="custom-table w-100">
            ...
            <tbody>
              {assessments.map((review, idx) => {
                ...
                const submitted = review.updated_at || review.created_at || 'Recently';
              ...
              {assessments.length === 0 && (
                <tr>
                  <td colSpan="6" className="text-center py-4 text-muted">
                    No manager assessments found in database.
                  </td>
                </tr>
              )}
            </tbody>
        ...
        <div className="d-flex justify-content-between align-items-center mt-4 text-muted small px-1 pt-2">
          <div>Showing 1–{assessments.length} of {assessments.length}</div>
